...
# p = Function(name='p', grid=grid, staggered=NODE, space_order=2)
v_x = TimeFunction(name='v_x', grid=grid, staggered=(x,), space_order=2, time_order=1)
v_z = TimeFunction(name='v_z', grid=grid, staggered=(z,), space_order=2, time_order=1)
